   ...
   public String getNumber(){
    ...
    public void setBalance(int balance){
        if(balance >= 0){
           ...
           // System.out.println("格式不符 保持原值");
            throw new NotMatchException("格式不符 保持原值");
        }
    }
    ...
    public void store(int money)throws InsufficientException{
        if(money > 0){
            ...
            throw new InsufficientException("儲值金額不得為負，來亂的!");
        }
    }
    ...
    private void topUp(int money) throws InsufficientException{
        if(this.number.equals(number)){
            ...
            throw new NotMatchException("卡號不符");
        }
    }
    ...
    private int exchange(int bouns) throws InsufficientException{
